...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  try {
    ...
    return {
      ...
      description: `Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laudantium delectus ab magnam voluptas ea quasi incidunt commodi laboriosam debitis blanditiis facere, ipsum impedit illo vero suscipit temporibus fugiat dolorem voluptates!`,
    };
  }
}
...
const getPokemonById = async (name: string): Promise<Pokemon> => {
  try {
    const pokemon = await fetch(`https://pokeapi.co/api/v2/pokemon/${name}`, {
      ...
      // next: { revalidate: 60 * 60 * 30 * 6 }, en 6 meses se revalida
    }).then((res) => res.json());
    // console.log(pokemon);
    return pokemon;
  } catch (error) {
